...
from cs336_basics.optimizer import CrossEntropyLoss, GradientClipping, AdamW, CosineScheduler
import wandb
...
def train(
    ...
    model = Transformer(device=device, **config["model"])
...
if __name__ == "__main__":
    train(
        train_dataset="tokenizer/tokenized_data.npy",
        config_path="cs336_basics/config.yaml", 
